<div class="sidebar">
    ...
    <li>
        ...
        <li><button onclick="window.location.href='{{ route('reporte_ausentismo') }}'">
            <svg
                class="size-5 sm:size-6"
                width="29"
                height="29"
        ...
        <li><button onclick="window.location.href='{{ route('fichamedica') }}'">
            <svg
                class="size-5 sm:size-6"
                width="8.4666mm"
                height="8.4666mm"
        ...
        <li><button onclick="window.location.href='{{ route('canalizaciones') }}'">
        ...
        <li><button onclick="window.location.href='{{ route('expedientes') }}'">
            <svg
                class="size-5 sm:size-6"
                width="8.4666mm"
                height="8.4666mm"
            ...
            Expedientes</button></li>
                <script>
        function toggleSidebar() {
            // Seleccionamos el sidebar y el contenido
            var sidebar = document.getElementById('sidebar');
            var content = document.getElementById('content');

            // Alternamos la clase para colapsar y expandir el sidebar
